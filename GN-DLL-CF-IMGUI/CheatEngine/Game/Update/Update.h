...
#define PlayerArrayBaseAddress 0x2E6AB70						//玩家数组
#define ModelOffset 0x2E6ABA0									//判断模式
#define ModelOffset2 0x2E6AA97									//模式基址
...
#define Hitchaddress 0x1403C9EB4								//绘制挂接地址				特征码：45 33 C9 45 33 C0 33 D2 E9 ?? ?? ?? ?? FF 15 ?? ?? ?? ?? 8B D8 
...
#define KnifeDistanceBaseAddress 0x300E450						//刀距基址 | 武器基址
