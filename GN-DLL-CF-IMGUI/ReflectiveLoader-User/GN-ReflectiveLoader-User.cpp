...
extern "C" __declspec(dllexport) VOID WINAPI GuNianDLLLoader(LPVOID ParameterData, ULONG_PTR RemoteBufferData, DWORD FunctionHashValue, LPVOID UserData, DWORD UserDataLength)
{
	PPEB Peb = NULL;
	ULONG_PTR Ldr = 0;
