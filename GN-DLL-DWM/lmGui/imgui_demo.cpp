...
bool ImGui::ShowStyleSelector(const char* label)
{
    ...
    if (ImGui::Combo(label, &style_idx, u8"À¶É«\0°×É«\0×ÏÉ«\0ºÚÉ«\0×Ï°×\0À¶°×\0Ç³ºÚ\0·Ûºì\0"))
    {
        switch (style_idx)
        {
        ...
        case 3: ImGui::StyleColorsChinaRed(); break;
        case 4: ImGui::StyleColorsSkyFly(); break;
        case 5: ImGui::StyleColorsOrangeNew(); break;
        case 6: ImGui::StyleColorsLightBlue(); break;
        case 7: ImGui::StyleColorsPurCool(); break;
        }
        return true;
    }
    return false;
